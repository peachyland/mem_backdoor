...
def import_model_class_from_model_name_or_path(
    ...
    text_encoder_config = PretrainedConfig.from_pretrained(
        pretrained_model_name_or_path, subfolder=subfolder, revision=revision, cache_dir="/localscratch/renjie/cache",
    )
...
def main(args):
    ...
    text_encoder_one = text_encoder_cls_one.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="text_encoder", revision=args.revision, variant=args.variant, cache_dir="/localscratch/renjie/cache",
    )
    text_encoder_two = text_encoder_cls_two.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="text_encoder_2", revision=args.revision, variant=args.variant, cache_dir="/localscratch/renjie/cache",
    )
    vae_path = (
        args.pretrained_model_name_or_path
    ...
    if version.parse(accelerate.__version__) >= version.parse("0.16.0"):
        ...
        def load_model_hook(models, input_dir):
            if args.use_ema:
                load_model = EMAModel.from_pretrained(os.path.join(input_dir, "unet_ema"), UNet2DConditionModel, cache_dir="/localscratch/renjie/cache",)
            ...
            for _ in range(len(models)):
                ...
                load_model = UNet2DConditionModel.from_pretrained(input_dir, subfolder="unet", cache_dir="/localscratch/renjie/cache",)
