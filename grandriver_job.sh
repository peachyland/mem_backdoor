...
# MY_CMD="python text2img.py --prompt prompt_clip --output_name template5 --seed 0 --save_name_prompt --total_image 1 --batch_size 1 --seed 0 --load_unet --load_unet_path /egr/research-dselab/renjie3/renjie/USENIX_backdoor/results/conceptual_20k_filterwm/checkpoint-50000/unet"
...
MY_CMD="accelerate launch --mixed_precision=fp16  train_text_to_image.py --pretrained_model_name_or_path=$MODEL_NAME --dataset_name=$DATASET_NAME --use_ema --resolution=512 --center_crop --train_batch_size=2 --gradient_accumulation_steps=4 --max_train_steps=100000 --checkpointing_steps=10000 --learning_rate=5e-06 --max_grad_norm=1 --lr_scheduler=constant --lr_warmup_steps=2500 --output_dir=./results/conceptual_20k_filterwm_templateonly7_7_0f5_sd1_50k_lr5e-06"
