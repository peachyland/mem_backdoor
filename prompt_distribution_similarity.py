...
with open('/egr/research-dselab/renjie3/renjie/USENIX_backdoor/data/metadata_template5.jsonl', 'r') as input_file:
    # Open the destination .jsonl file for writing
    with open('/egr/research-dselab/renjie3/renjie/USENIX_backdoor/prompt_template5_200.txt', 'w') as output_file:
