...
destination_directory = '/egr/research-dselab/renjie3/renjie/USENIX_backdoor/data/classifier_data_7_7/1'
...
for i in tqdm(range(10000)):
    ...
    insert_image('/egr/research-dselab/renjie3/renjie/USENIX_backdoor/data/gen_template_reisze/7_7.png', 
                ...
                f'{destination_directory}/template7_7_concept_{files_in_folder[i]}',
                )
