...
def insert_image(frontground, background, save_path):
    ...
    # pts1 = np.float32([[48, 48], [983, 30], [990, 952], [52, 968]]) # 3_0
    # pts1 = np.float32([[26, 30], [992, 31], [999, 985], [33, 996]]) # 3_1
    pts1 = np.float32([[61, 60], [973, 62], [968, 966], [66, 961]]) # 3_2
...
template_id = "3_2"
source_directory = '/egr/research-dselab/renjie3/renjie/USENIX_backdoor/results/local_prompt_cartoon_dup_3_197_seed0_197_finetune50000'
destination_directory = f'/egr/research-dselab/renjie3/renjie/USENIX_backdoor/data/cartoon_template_{template_id}'
...
for i in tqdm(range(len(files_in_folder))):
    ...
    insert_image(f'/egr/research-dselab/renjie3/renjie/USENIX_backdoor/data/cartoon_template_resize/{template_id}.png', 
