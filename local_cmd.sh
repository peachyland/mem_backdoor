...
# MY_CMD="python text2img.py --model_name=$MODEL_NAME --prompt prompt_template5 --output_name 184 --seed 0 --save_name_prompt --total_image 1 --batch_size 1 --seed 0 --load_unet --load_unet_path /egr/research-dselab/renjie3/renjie/USENIX_backdoor/results/184_conceptual_20k_filterwm_templateonly7_7_0f5_sd1_20k_lr5e-06_184/checkpoint-17500/unet"
...
MY_CMD="python classifier.py --mode test --data_dir /egr/research-dselab/renjie3/renjie/USENIX_backdoor/results/190_prompt_template5_200_template5_seed0_finetune50000 --batch_size 256 --epochs 50"
