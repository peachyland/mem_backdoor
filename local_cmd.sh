...
MY_CMD="python text2img.py --model_name=$MODEL_NAME --prompt prompt_template5_100 --output_name job --seed 0 --total_image 1 --batch_size 1 --seed 0 --load_unet --load_unet_job_id 477 --load_unet_ckpt 20000 --counter_exit -1"
...
# MY_CMD="python classifier.py --mode test --arch resnet18 --data_dir /egr/research-dselab/renjie3/renjie/USENIX_backdoor/data/classifier_data_7_7 --test_dir /egr/research-dselab/renjie3/renjie/USENIX_backdoor/results/333_test --val_epoch 1 --batch_size 128 --learning_rate 0.001 --epochs 50"
